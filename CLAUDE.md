...
- **`topology.md`** — vistas generadas: un diagrama Mermaid del mapeo cliente → WebLogic → DB, una tabla de categorías, y notas sobre hosts/clusters ESXi (incluyendo el punto abierto sobre "Piedras").
