...
4. **ABB — cuál de las dos DBs es la productiva** (`192.1.1.31` / `DBClientes-12C.31` vs `192.1.1.190` / `DBClientes.190`) — detalle abajo. **Actualización (6 sep 2026):** se resuelve como subproducto del próximo trazado, **BOCA** (`plan_relevamiento_alta_boca.md`) — BOCA y ABB son co-inquilinos del mismo WebLogic `192.1.2.54`, nunca accedido; una sola sesión de consola lee los datasources de los dos (y de paso da evidencia en vivo para ESYOP/DCVIAJES según a qué DB apunte ABB, y cierra la cola de EBY que vive en ese box).
