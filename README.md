...
2. Mirar por arriba **[infra/topology.md](infra/topology.md)** — dos diagramas: qué cliente está en qué servidor WebLogic/DB (on-premise), y la configuración aparte de Azure/AKS (cloud).
...
| Firewall pfSense | Configuración de VPN de Azure (match por IP del peer) | 1 de 9 firewalls candidatos confirmado; el resto siguen siendo conjeturas |
| Azure/AKS (acá corren Condor Work/Enterprise/ProvIA) | Análisis interno de Azure | Suscripciones, redes y VPN mapeadas; se encontró un hallazgo real: red plana, sin NSGs |
