...
**Uno de dos trazados en paralelo.** Ver también [`relevamiento_alta_jobs.md`](relevamiento_alta_jobs.md) — mismo objetivo, con JOBS como cliente de referencia (cadena más dedicada, sirve de contraste). La receta final debería convalidarse contra los dos.
...
3. **Lo que de verdad importa:** una vez recorridas las 6 capas, escribir acá abajo la receta generalizada, cruzada con `relevamiento_alta_jobs.md` — validada contra dos casos reales, no inferida de la documentación.
